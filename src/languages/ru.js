...
export default {
  ...
  downloads: {
    ...
    note1:
      "⚠️ Примечание: Возможно, потребуется исключить main.exe из вашего брандмауэра или временно его отключить, чтобы клиент мог подключиться.",
    note2_desc: `
      <strong>Изменение разрешения:</strong> Вы можете отредактировать файл
